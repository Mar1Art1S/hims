<header>
    <nav x-data="{ open: false }" class="duration-500 bg-blue-800">
        <div class="relative flex items-center justify-between h-32 mx-5 containe">
            ...
            <div class="flex items-center flex-shrink-0">
                <a href="{{ route('main') }}" class="block">
                    <img class="object-contain h-20 lg:h-24" src="{{ asset('img/2_logo/Logo.png') }}" alt="Логотип" />
                </a>
            </div>
                ...
                <div class="hidden w-full sm:ml-6 lg:block">
                    <div class="flex space-x-4">
                        <x-menu>
                            ...
                            <x-menu.item :link="route('blog')" :active="request()->routeIs('blog')">
                                {{ __('Блог') }}
                            </x-menu.item>
                        </x-menu>
                    </div>
            ...
            <div class="inset-y-0 right-0 flex items-center lg:hidden ms-8">
                <!-- Mobile menu button-->
        ...
        <div x-show="open" x-collapse class="lg:hidden" id="mobile-menu">
    ...
    <div class="w-full bg-amber-400">
        <div class="flex flex-row items-center justify-between mx-5 h-14">
            <div class="flex items-center justify-end text-white">
                <div class="text-base leading-normal text-right font-r400">
                    {{ __('м.Кременчук') }}
                </div>

                <x-modal title="Замовлення товару">
                    <x-slot:button>
                        <x-button @click="modalOpen=true" class="px-5 py-1.5 ms-4 bg-blue-800 border-none rounded-lg">
                            Замовити
                        </x-button>
                    </x-slot>
                    <livewire:order />
