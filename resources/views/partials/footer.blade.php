        ...
        <div class="w-full bg-blue-800 max-h-32 lg:col-span-1 md:max-h-32 md:w-full">
            <a href="{{ route('main') }}">
                <img class="object-contain w-[400px] sf:w-[280px] mx-auto"
                    src="{{ Vite::asset('resources/img/2_logo/Logo.png') }}" alt="Logo" />
            </a>
        </div>
        <div class="grid grid-cols-2 gap-8 fg:grid-cols-1 sf:px-4">
            <div class="ml-6 ">
                ...
                <div class="flex flex-row justify-start order-1 mt-2">
                    <div class=" text-gray-900 font-r400 text-start text-1.5xl xs:text-sm">{{ __('Графік роботи:') }}
                    </div>
                    <div class="ml-4 text-lg"><span class="font-r500 text-1.5xl xs:text-sm">{{ __('Пн-Пт:') }} </span>
                        {{ __('с
                        8:30 до 17:00') }} <span class="font-r500 text-1.5xl xs:text-sm">{{ __('Сб-Нд:') }} </span>{{
                        __('Вихідний') }}</div>
                </div>
            </div>
