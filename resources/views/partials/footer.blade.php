        ...
        <div class="grid grid-cols-2 gap-8">
            <div class="ml-6 ">
                <div class="w-full mt-4 ">
                    <span
                        class="flex justify-start my-2 text-lg tracking-wide text-center text-gray-500 uppercase">
                        {{ __('Приймальна директора:') }}
                    </span>
                    <div class="flex flex-row w-full gap-2 ml-2">
                        <div class="w-1/2">
                            <div>{{__('Телефон')}}</div>
                            <div>
                                <a href="tel:+380504756847"
                                    class="block text-1.5xl text-gray-900 font-r500 hover:opacity-75 sm:text-3xl">
                                    {{__('+38 (050) 475-68-47')}}
                                </a>
                            </div>
                        </div>
                ...
                <div class="flex flex-row items-center order-1 mt-5">
                    <div class="w-1/2 ml-2 text-gray-900 text-start font-r400">
                        {{ __('По всіх технологічним, логістичним питанням звертайтесь за') }}
                    </div>
                    <a href="tel:+380503403547" class="w-1/2 block text-1.5xl ml-4 font-r500">{{ __('+38 (050) 340-35-47') }}</a>
                </div>
                <div class="items-center bg-gray-200">
                    <ul class="flex items-center justify-around gap-2 mt-2 ">
                        <li>
                ...
                <div class="flex flex-row justify-start order-1 mt-2">
                    <div class=" text-gray-900 font-r400 text-start text-1.5xl">{{ __('Графік роботи:') }} </div>
                    <div class="ml-4 text-lg"><span class="font-r500 text-1.5xl">{{ __('Пн-Пт:') }} </span> {{ __('с
