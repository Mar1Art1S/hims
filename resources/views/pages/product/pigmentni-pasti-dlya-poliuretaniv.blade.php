...
@section('meta_description', __('Пігментні пасти для поліуретанів забезпечують насичені кольори та високу стабільність забарвлення у виробах
з поліуретану. Ідеальні для застосування в будівництві, автомобільній промисловості та виробництві меблів. Пасти легко змішуються
з поліуретановими системами, гарантують рівномірний розподіл кольору та зберігають свої властивості в умовах експлуатації.'))
@section('meta_keywords', __('пігментні пасти для поліуретанів, забарвлення поліуретанових виробів, кольорові пасти для поліуретану,
пігментація поліуретанів, поліуретанові пігментні добавки, насичені кольори для поліуретанів, пігментні пасти для промислових полімерів,
...
@section('og_description', __('Пігментні пасти для поліуретанів забезпечують насичені кольори та високу стабільність забарвлення у виробах
з поліуретану. Ідеальні для застосування в будівництві, автомобільній промисловості та виробництві меблів. Пасти легко змішуються
з поліуретановими системами, гарантують рівномірний розподіл кольору та зберігають свої властивості в умовах експлуатації.'))
